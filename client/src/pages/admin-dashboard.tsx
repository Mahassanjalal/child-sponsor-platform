          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  {childrenList?.filter(c => c.isSponsored).map((child) => (
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input {...field} placeholder="Monthly Progress Update" data-testid={`input-${p}report-title`} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea {...field} placeholder="Share updates about the child's progress..." className="min-h-[120px] resize-none" data-testid={`input-${p}report-content`} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>Photo URL</FormLabel>
            <FormControl>
              <Input {...field} placeholder="https://..." data-testid={`input-${p}report-photo`} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete this child profile? This action cannot be undone and will also remove all associated reports."
        onConfirm={() => deleteChildId && deleteChildMutation.mutate(deleteChildId)}
        isPending={deleteChildMutation.isPending}
        confirmLabel="Delete"
        pendingLabel="Deleting..."
        cancelTestId="button-cancel-delete-child"
        confirmTestId="button-confirm-delete-child"
      />
      ...
      <ConfirmDialog
        ...
        confirmLabel="Delete"
        pendingLabel="Deleting..."
        cancelTestId="button-cancel-delete-report"
        confirmTestId="button-confirm-delete-report"
      />
        ...
        <DialogContent>
          ...
          <Form {...reportForm}>
            <form onSubmit={reportForm.handleSubmit(handleReportSubmit)} className="space-y-4">
              <ReportFormFields form={reportForm} testIdPrefix="edit-" />
              <Button
                type="submit"
                className="w-full"
